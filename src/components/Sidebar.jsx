    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ padding: "0 12px 14px", display: "flex", flexDirection: "column", gap: 2, WebkitAppRegion: "no-drag" }}>
        <button
          ...
          onMouseEnter={(e) => { applyPaneInteractionStyle(e.currentTarget, "hover"); e.currentTarget.style.color = "var(--text-primary)"; }}
        ...
        {searchOpen && <div
          style={{
            ...
            marginTop: 6,
            padding: "6px 10px",
            border: "1px solid " + (searchFocused ? "var(--search-focus-border)" : "var(--pane-border)"),
            borderRadius: 8,
