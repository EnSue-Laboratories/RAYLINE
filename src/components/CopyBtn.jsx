  ...
  return (
    <button
      ...
      style={{
        background: "none",
        border: "none",
        color: ok ? "var(--success-soft-text)" : "var(--icon-secondary)",
        cursor: "pointer",
        padding: "2px 4px",
        borderRadius: 3,
        transition: "color .2s",
      ...
      onMouseEnter={(e) => { if (!ok) e.currentTarget.style.color = "var(--icon-primary)"; }}
      onMouseLeave={(e) => { if (!ok) e.currentTarget.style.color = "var(--icon-secondary)"; }}
    >
