  ...
  return (
    <button
      ...
      style={{
        ...
        border: "none",
        borderRadius: 7,
        color: danger ? "rgba(210,80,80,0.7)" : "color-mix(in srgb, var(--text-primary) 55%, transparent)",
        fontSize: s(11),
        fontFamily: "system-ui, sans-serif",
        cursor: "pointer",
        textAlign: "left",
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.color = danger ? "rgba(220,90,90,1)" : "color-mix(in srgb, var(--text-primary) 85%, transparent)";
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.background = "transparent";
        e.currentTarget.style.color = danger ? "rgba(210,80,80,0.7)" : "color-mix(in srgb, var(--text-primary) 55%, transparent)";
      }}
    >
      {label}
    </button>
